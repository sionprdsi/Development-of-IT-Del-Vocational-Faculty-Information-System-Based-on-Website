...
@section('main-content')
    ...
    <div class="page-header mb-4">
        <h1 class="h2 text-primary font-weight-bold mb-3" style="border-bottom: 2px solid #4C74DC; padding-bottom: 10px;">
            {{ __('Halaman Struktur Organisasi Fakultas Vokasi') }}
        </h1>
    ...
    <div class="row">
        <div class="col-lg-12 order-lg-1">
            <div class="card shadow mb-4" style="border-radius: 12px; overflow: hidden; padding: 20px;">
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.struktur_organisasi.update') }}"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="form-group">
                            <label for="nama_struktur_organisasi">Nama Struktur Organisasi</label>
                            <input type="text" class="form-control" id="nama_struktur_organisasi"
                                name="nama_struktur_organisasi"
                                value="{{ $struktur_organisasi->nama_struktur_organisasi ?? '' }}" required>
                        </div>

                        <div class="form-group">
                            <label for="gambar">Gambar</label>
                            <input type="file" class="form-control-file" id="gambar" name="gambar">
                            @if ($struktur_organisasi && $struktur_organisasi->gambar)
