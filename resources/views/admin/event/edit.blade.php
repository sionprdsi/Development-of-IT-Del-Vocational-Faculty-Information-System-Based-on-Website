    ...
    <div class="container-fluid">
        ...
        <div class="page-header mb-4">
            <h1 class="h2 text-primary font-weight-bold mb-3" style="border-bottom: 2px solid #4C74DC; padding-bottom: 10px;">
                {{ __('Halaman Edit Agenda Fakultas Vokasi') }}
            </h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light rounded shadow-sm p-3 mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" style="color: #4C74DC;">Halaman Edit Agenda
                        Fakultas Vokasi</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.event.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ $event->nama }}" placeholder="Masukkan nama event" class="form-control tinymce" required>
                    </div>
                    <div class="form-group">
                        <label class="title-label" for="detail">Detail Tempat Agenda<span class="small text-danger">*</span></label>
                        <textarea name="detail" id="detail" rows="5" placeholder="Masukkan detail event" class="form-control tinymce" required>{{ $event->detail }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="keterangan" id="keterangan" value="{{ $event->keterangan }}" placeholder="Masukkan keterangan tambahan" class="form-control">
                    </div>
                    <div class="form-group">
                        <label class="title-label" for="created_at">Tanggal Pembuatan Posting<span class="small text-danger">*</span></label>
                        <input type="text" name="created_at" id="created_at" value="{{ $event->created_at }}" class="form-control" readonly>
                    </div>
