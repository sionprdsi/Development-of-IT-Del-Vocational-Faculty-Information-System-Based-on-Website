    ...
    <div class="container-fluid">
        ...
        <div class="page-header mb-4">
            <h1 class="h2 text-primary font-weight-bold mb-3" style="border-bottom: 2px solid #4C74DC; padding-bottom: 10px;">
                {{ __('Halaman Edit Pengumuman Fakultas Vokasi') }}
            </h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light rounded shadow-sm p-3 mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" style="color: #4C74DC;">Halaman Edit Pengumuman
                        Fakultas Vokasi</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        <label class="title-label" for="judul">Judul Pengumuman<span class="small text-danger">*</span></label>
                        <input type="text" name="judul" id="judul" value="{{ $pengumuman->judul }}"
                            placeholder="Masukkan judul pengumuman" class="form-control" required>
                    </div>
                    <div class="card shadow">
                        <div class="card-body">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="konten" id="konten" rows="5" placeholder="Masukkan konten pengumuman" class="form-control tinymce" >{{ $pengumuman->konten }}</textarea>
                    </div>
                    <div class="form-group">
                        <label class="title-label" for="tanggal">Tanggal Pengumuman<span class="small text-danger">*</span></label>
                        <input type="date" name="tanggal" id="tanggal" value="{{ $pengumuman->tanggal }}"
                            class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label class="title-label" for="keterangan">Keterangan<span class="small text-danger">*</span></label>
                        <input type="text" name="keterangan" id="keterangan" value="{{ $pengumuman->keterangan }}"
