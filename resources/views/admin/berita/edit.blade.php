    ...
    <div class="container-fluid">
        ...
        <div class="page-header mb-4">
            <h1 class="h2 text-primary font-weight-bold mb-3" style="border-bottom: 2px solid #4C74DC; padding-bottom: 10px;">
                {{ __('Halaman Edit Berita Fakultas Vokasi') }}
            </h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light rounded shadow-sm p-3 mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/berita" style="text-decoration: none; color: #4C74DC;">Berita
                            Vokasi</a></li>
                    <li class="breadcrumb-item active" aria-current="page" style="color: #4C74DC;">Halaman Edit Berita
                        Fakultas Vokasi</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                @if (!empty($berita->foto))
                                    <img src="{{ Storage::url($berita->foto) }}" alt="Foto kalender" width="150" class="mt-2" style="display: block;">
                                @else
                                    <span style="color: red;">Foto tidak ada dipilih</span>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="konten" id="konten" rows="5" placeholder="Masukkan detail berita" class="form-control"
                            required>{{ $berita->konten }}</textarea>
                    </div>
                    <div class="form-group">
                        <label class="title-label" for="tanggal">Tanggal Diperbaharui<span class="small text-danger">*</span></label>
                        <input type="date" name="tanggal" id="tanggal" value="{{ $berita->tanggal }}"
                            placeholder="Masukkan tanggal terkait berita" class="form-control" required min="{{ date('Y-m-d') }}">
                    </div>
