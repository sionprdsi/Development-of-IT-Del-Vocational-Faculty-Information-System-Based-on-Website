        ...
        <div class="page-header mb-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-light rounded shadow-sm p-3 mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="/admin/prodi" style="text-decoration: none; color: #4C74DC;">Program
                            Studi</a></li>
                    <li class="breadcrumb-item active" aria-current="page" style="color: #4C74DC;">Tambah Program Studi</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.prodi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="nama" role="tabpanel"
                            aria-labelledby="nama-tab">
                        ...
                        <div class="tab-pane fade" id="subjudul" role="tabpanel" aria-labelledby="subjudul-tab">
                            <div class="form-group">
                                ...
                                <input type="text" name="subjudul" id="subjudul"
                                    placeholder="Masukkan subjudul program studi" class="form-control" required>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="foto" role="tabpanel" aria-labelledby="foto-tab">
                            <div class="form-group">
                                ...
                                <input type="file" name="foto" id="foto" accept="image/*"
                                    placeholder="Upload foto" class="form-control" required>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="sejarah" role="tabpanel" aria-labelledby="sejarah-tab">
                            <div class="form-group">
                                ...
                                <textarea name="sejarah" id="sejarah" rows="5" placeholder="Masukkan sejarah program studi"
                                    class="form-control tinymce" required></textarea>
                            </div>
                        </div>
                        ...
                        <div class="tab-pane fade" id="lulusan" role="tabpanel" aria-labelledby="lulusan-tab">
                            <div class="form-group">
                                ...
                                <textarea name="lulusan" id="lulusan" rows="3"
                                    placeholder="Masukkan informasi tentang lulusan program studi" class="form-control tinymce" required></textarea>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="kurikulum" role="tabpanel" aria-labelledby="kurikulum-tab">
                            <div class="form-group">
                                ...
                                <textarea name="kurikulum" id="kurikulum" rows="3"
                                    placeholder="Masukkan informasi tentang kurikulum program studi" class="form-control tinymce"  required></textarea>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="teks_dosen" role="tabpanel" aria-labelledby="teks_dosen-tab">
                            <div class="form-group">
                                ...
                                <textarea name="teks_dosen" id="teks_dosen" rows="3"
                                    placeholder="Masukkan informasi tentang dosen program studi" class="form-control tinymce" required></textarea>
                            </div>
                        </div>
                    </div>
