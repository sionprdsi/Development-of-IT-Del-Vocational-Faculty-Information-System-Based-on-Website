        ...
        <section style="margin-bottom:1%" class="breadcrumbs">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="breadcrumbs-title">Tujuan Vokasi</h2>
                    <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <span itemprop="name" style="color: #1977cc">Tujuan Vokasi</span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="header-title">
                            <span style="font-size:130%" class="sub-title">Tujuan Fakultas Vokasi Institut Teknologi
                                Del</span>
