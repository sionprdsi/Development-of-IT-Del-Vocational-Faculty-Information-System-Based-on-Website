            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                        ...
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <span itemprop="name" style="color: #1977cc">D-IV Teknologi Rekayasa Perangkat
                                Lunak</span>
                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry entry-single">
                            <div class="header-title mb-md-5 mt-4">
                                <span class="sub-title">Sejarah, Visi-Misi, Profil Lulusan, Struktur Kurikulum</span>
                                <h3 class="hny-title text-left">Sarjana Terapan (D4) <b>Teknologi Rekayasa Perangkat
                                        Lunak</b></h3>
                            </div>
                            <div class="entry-img">
                            ...
                            <div class="header-title mb-md-5 mt-4">
                                <h2 class="entry-title" style="font-size: 230%">
                                    <a href="">Sejarah Diploma 4 atau Sarjana Terapan</a>
                                </h2>
                            </div>

                            <div class="entry-content">
                                <p>
                                    Sarjana Terapan (Diploma 4) Teknologi Rekayasa Perangkat Lunak (Sarjana Terapan
                                    TRPL) merupakan program studi pada pendidikan vokasi. Diploma 4 (D4) adalah nama
                                    lain dari Sarjana Terapan. Program studi Sarjana Terapan TRPL berdiri pada tahun
                                    2012 sesuai dengan SK Menteri Pendidikan dan Kebudayaan Republik Indonesia No.
                                    238/E/O/2012 pada tanggal 6 Juli 2012 dengan nama Sarjana Terapan (DIV) Teknik
                                    Informatika. Perubahan nama dari program studi DIV Teknik Informatika menjadi DIV
                                    Teknologi Rekayasa Perangkat Lunak adalah mengikuti nomenklatur Program Studi sesuai
                                ...
                                <blockquote>
                                    <p>
                                        Sarjana Terapan merupakan jenjang pendidikan diploma yang setara dengan jenjang
                                        sarjana. Sarjana terapan adalah pendidikan vokasi sedangkan sarjana (S1) adalah
                                        pendidikan akademik. Bobot keilmuan D4 sama dengan S1 sehingga disebut setara.
                                        Perbedaan keduanya adalah pada komposisi mata kuliah.
                                    </p>
                                </blockquote>

                                <p>
                                    Kuliah di jenjang D4 mengedepankan kemampuan praktik yang dibutuhkan di dunia kerja,
                                    sekaligus pengetahuan ilmu yang lebih lengkap dibanding jenjang diploma dibawah D4.
                                    Mata kuliah D4 mengutamakan 60% praktik dan 40% teori, berbeda dengan S1 bertitik
                                    berat pada teori dibandingkan praktik. Jika lebih senang terjun ke lapangan untuk
                                    memecahkan masalah, jenjang D4 menjadi pilihan yang sangat tepat.
                                </p>
                                <p>
                                    Karena bobot perkuliahan yang sama dengan S1, maka mahasiswa jenjang D4 bisa
                                    langsung melanjutkan studi ke jenjang S2. Bobot perkuliahan D4 dan S1 adalah minimum
                                    144 SKS. Jadi, lulusan D4 tidak perlu melanjutkan pendidikan ekstensi terlebih
                                    dahulu. D4 (Sarjana Terapan) dan S1 (Sarjana) memiliki peluang kerja yang sama
                                    dengan keunggulan masing-masing. Bahkan untuk seleksi CPNS dan pegawai BUMN juga
                                    sudah menerima mahasiswa lulusan D4. Program D4 bersinergi erat dengan industri,
                                    maka kurikulum pendidikannya dirancang bersama industri, sehingga lulusan D4 menjadi
                                    ahli yang siap terjun dan bekerja di industri. </p>
                                ...
                                <div class="header-title mb-md-5 mt-4">
                                    ...
                                    <h3>Visi</h3>
                                    <p>
                                        Menjadikan Program Studi Teknologi Rekayasa Perangkat Lunak Program Sarjana
                                        Terapan
                                        sebagai batu loncatan menuju masa depan Teknologi Informasi yang
                                        mengintegrasikan
                                        dunia pendidikan dengan kebutuhan usaha akan tenaga profesional informatika yang
                                        mampu bersaing secara global.
                                    </p>
                                    <h3>Misi</h3>
                                    <p>
                                        Menyelenggarakan pendidikan vokasional yang mendidik dan menghasilkan sumber
                                        daya
                                        manusia yang mempunyai sikap memimpin, penuh kreativitas, berdisiplin tinggi,
                                        dan
                                        mampu memberikan solusi di bidang Teknologi Informasi secara global<br>
                                        Membuat terobosan dalam dunia pendidikan dengan menciptakan lingkungan
                                        pendidikan
                                        yang sehat, kondusif dengan dukungan tenaga pengajar yang ahli dan
                                        profesional.<br>
                                        Menyelenggarakan program penelitian yang menghasilkan produk teknologi informasi
                                        yang memberikan solusi tepat guna dan inovatif untuk diterapkan di berbagai
                                        bidang
                                        kehidupan masyarakat.<br>
                                        Menyelenggarakan proses pengabdian kepada masyarakat di dunia teknologi
                                        informasi
                                        melalui berbagai program diseminasi teknologi informasi terhadap masyarakat di
                                        berbagai bidang.<br>
                                    </p>
                                </div>
                                ...
                                <div class="header-title mb-md-5 mt-4">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <p>
                                                Software developer adalah seseorang yang terlibat dalam fase-fase
                                                pengembangan perangkat lunak yang meliputi penggalian kebutuhan,
                                        ...
                                        <li>
                                            ...
                                            <p>
                                                Software quality assurance adalah seorang praktisi yang bekerja untuk
                                        ...
                                        <li>
                                            <h3>IT Researcher</h3>
                                            <p>
                                                IT Researcher adalah lulusan informatika dapat bekerja sebagai peneliti
                                                di bidangnya.
                                            </p>
                                        </li>
                                        <li>
                                            <h3>IT preneur</h3>
                                            <p>
                                                ITpreneur adalah seseorang yang memiliki usaha di bidang teknologi.
                                            </p>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="header-title mb-md-5 mt-4">
                                    <h2 class="entry-title" style="font-size: 170%">
                                        <a class="sub-title" style="font-size:115%" href="">Dosen Pengajar di
                                            Sarjana Terapan TRPL</a>
                                    </h2>
                                    <!-- Deskripsi Dosen Pengajar -->
                                    <p>Dosen pengajar di program studi Sarjana Terapan TRPL adalah lulusan universitas
                                        terbaik di dalam dan luar negeri, dengan keahlian di bidang software
                                    ...
                                    <ul>
                                        ...
                                        <li><strong>Verawaty Situmorang, S.Kom., M.T.I (Alumni Del, program
                                                vokasi)</strong></li>
                                        <li><strong>Yohanssen Pratama, S.Si, M.T</strong></li>
                                        <li><strong>Batara Parada Siahaan, S.Kom., M.S.M. (Alumni Del, program
                                                vokasi)</strong></li>
                                        <li><strong>Ardiles Sinaga, S.T., M.T.</strong></li>
                                        <li><strong>Sahat Pandapotan Nainggolan, S.Mat., M.Pmat</strong></li>
                                        <li><strong>Regina Ayunita Tarigan, S.Si., M.Sc</strong></li>
                                        <li><strong>Rumondang Miranda Marsaulina, S.P, M.Si</strong></li>
                                    </ul>
